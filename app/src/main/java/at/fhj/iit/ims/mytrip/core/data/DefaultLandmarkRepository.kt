...
import at.fhj.iit.ims.mytrip.core.data.local.MockLandmarkDataSource
 ...
 * Replace [MockLandmarkDataSource] with a Room/Network implementation later.
 */
class DefaultLandmarkRepository(
    private val dataSource: MockLandmarkDataSource = MockLandmarkDataSource()
) : LandmarkRepository {
